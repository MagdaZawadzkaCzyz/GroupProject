...
<head>
    ...
    <title>Studio alternatywnych fryzur</title>
        ...
        <div class="row">
            ...
            <div class="col-6 col-md">
                <ul class="list-unstyled text-small">
                    <li><a class="text-muted" href="#">O nas</a></li>
                    <li><a class="text-muted" href="#">Wykonywane usługi</a></li>
                    <li><a class="text-muted" href="#">Cennik</a></li>
                </ul>
            </div>
            <div class="col-6 col-md">
                <ul class="list-unstyled text-small">
            ...
            <div class="col-6 col-md">
                <ul class="list-unstyled text-small">
                    ...
                    <li><a class="text-muted" href="#">Regulamin rezerwacji</a></li>
                </ul>
            </div>
        </div>
    </footer>
